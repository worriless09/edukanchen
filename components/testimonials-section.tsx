...
const testimonials = [
  {
    ...
    content:
      "Kanchen Academy's AI flashcards were a game-changer for my preparation. The spaced repetition helped me retain vast amounts of information effortlessly.",
    rating: 5,
  },
  {
    name: "Rahul Kumar",
    ...
    content:
      "The comprehensive course structure and expert faculty guidance helped me crack SSC CGL in my first attempt. Highly recommended!",
    rating: 5,
  },
  {
    name: "Anjali Patel",
    ...
    content:
      "The personalized study plans and regular mock tests kept me on track throughout my preparation journey. Thank you Kanchen Academy!",
    rating: 5,
  },
]
