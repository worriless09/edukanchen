-- Kanchen Academy Database Schema - Simplified (No HRM)
-- Educational platform for UPSC, SSC, and Banking exam preparation
...
CREATE TABLE quiz_responses (
  ...
  time_taken INTEGER, -- seconds
  confidence_level DECIMAL(3,2), -- Self-reported
...
CREATE TABLE flashcard_decks (
  ...
  original_deck_id UUID, -- If copied from another deck
...
-- User flashcard progress (simplified SM-2 algorithm)
...
CREATE TABLE payment_transactions (
  ...
  -- Transaction details
  transaction_type VARCHAR(50) NOT NULL CHECK (transaction_type IN ('subscription', 'course_purchase', 'quiz_access')),
  reference_id UUID,
...
CREATE TABLE notification_templates (
  ...
  delivery_methods VARCHAR(50)[] DEFAULT '{"in_app"}',
  is_active BOOLEAN DEFAULT true,
  created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
  updated_at TIMESTAMP WITH TIME ZONE DEFAULT NOW()
);
...
INSERT INTO subjects (name, code, exam_type, difficulty_level) VALUES 
('General Studies', 'UPSC_GS', 'UPSC', 3),
('Quantitative Aptitude', 'SSC_QA', 'SSC', 2),
('Banking Awareness', 'BANK_BA', 'BANKING', 2);

INSERT INTO subscription_plans (name, display_name, description, price_monthly, price_yearly) VALUES 
('free', 'Free Plan', 'Basic features for beginners', 0, 0),
('basic', 'Basic Plan', 'Essential features for serious learners', 299, 2999),
('premium', 'Premium Plan', 'All features for comprehensive preparation', 599, 5999);